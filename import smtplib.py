...
print("\nGithub: https://github.com/mhagne/PORTcanner\n")
...
def get_ports(mode):
    if mode == 1:
        ...
        print("[+] Yellow option selected.")
        sys.exit()
    elif mode == 5:
        print("[+] Green option selected.")
        sys.exit()
    elif mode == 6:
        print("[+] Red option selected.")
        sys.exit()
    elif mode == 7:
        print("[-] Exiting...")
        sys.exit()
...
print(f"Scanning complete at: {current_time}")
